...
export const STARTER_ITEMS: StarterTemplate[] = [
  ...
  {
    id: "starter-jcrew-1450-chino",
    brand: "J.Crew",
    retailerProductTitle: "1450 Relaxed-fit stretch chino",
    productUrl:
      "https://www.jcrew.com/p/mens/categories/clothing/pants-and-chinos/athletic/1450-relaxed-fit-stretch-chino/G9488",
    category: "bottom",
    colors: "varies",
    seasons: "spring, summer, fall, winter",
    formality: "smart-casual",
    notes: null,
    tags: "starter, jcrew, mens, chinos",
  },
  {
    id: "starter-jcrew-short-sleeve-oxford",
    brand: "J.Crew",
    retailerProductTitle: "Short-sleeve oxford shirt",
    productUrl:
      "https://www.jcrew.com/p/mens/categories/clothing/shirts/broken-in-oxford/short-sleeve-oxford-shirt/AJ719",
    category: "top",
    colors: "varies",
    seasons: "spring, summer",
    formality: "smart-casual",
    notes: null,
    tags: "starter, jcrew, mens, oxford, short-sleeve",
  },
  {
    id: "starter-gap-oxford-shirt",
    brand: "Gap",
    retailerProductTitle: "Oxford Button-Down Shirt",
    productUrl: "https://www.gap.com/browse/product.do?pid=787704012",
    category: "top",
    colors: "light blue and other colorways",
    seasons: "spring, summer, fall, winter",
    formality: "smart-casual",
    notes: null,
    tags: "starter, gap, mens, oxford",
  },
  {
    id: "starter-banana-republic-chambray",
    brand: "Banana Republic",
    retailerProductTitle: "Standard-Fit Chambray Shirt",
    productUrl: "https://bananarepublic.gap.com/browse/product.do?pid=8712560020005",
    category: "top",
    colors: "cerulean blue",
    seasons: "spring, summer, fall",
    formality: "smart-casual",
    notes: null,
    tags: "starter, banana republic, mens, chambray",
  },
  {
    id: "starter-old-navy-everyday-oxford",
    brand: "Old Navy",
    retailerProductTitle: "Classic Fit Everyday Oxford Shirt",
    productUrl: "https://oldnavy.gap.com/browse/product.do?pid=6898860120002",
    category: "top",
    colors: "black and other colorways",
    seasons: "spring, summer, fall, winter",
    formality: "casual",
    notes: null,
    tags: "starter, old navy, mens, oxford",
  },
];
